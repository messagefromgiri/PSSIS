...
Param(
    ...
    [string] $ResourceGroupName = 'SIS-PD-ST-04-BE-RG001',
    [switch] $UploadArtifacts = $true,
    [string] $StorageAccountName = "sispd04sragrssa002",
...
foreach ($AzureVMName in $AzureVMNames) {
    ...
    ##Golden Image Value
    $OptionalParameters['templateResourceID'] = '/subscriptions/857c1477-d81b-418e-8867-d26eaf6d4d5b/resourceGroups/SIS-PD-IM-04-T0-RG001/providers/Microsoft.Compute/images/SISPDDB04WIMG001'
    ##Key Vault
    ...
    $OptionalParameters['pIPAddress'] = Powershell -file ..\..\Scripts\Set-IPAllocator.ps1 -Path ..\..\Scripts\SIS-DB-SN001-172.22.168.0_21.csv -HostName ($AzureVMName + "-Nic")
    $OptionalParameters['sIPAddress'] = Powershell -file ..\..\Scripts\Set-IPAllocator.ps1 -Path ..\..\Scripts\SIS-DB-SN001-172.22.168.0_21.csv -HostName ($AzureVMName + "-BNic")
