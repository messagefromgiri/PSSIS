...
Param(
    ...
    [string] $ResourceGroupName = 'SIS-PD-ST-50-BE-RG001',
    [switch] $UploadArtifacts = $true,
    [string] $StorageAccountName = "sispd50sragrssa002",
...
foreach ($AzureVMName in $AzureVMNames) {
    ...
    $OptionalParameters['subnetName'] = 'SIS-DB-SN001-172.21.8.0_21'
    $OptionalParameters['domainToJoin'] = "powerschool.host"
    $OptionalParameters['domainUsername'] = "sundeep.paluru"
    ##Golden Image Value
    $OptionalParameters['templateResourceID'] = '/subscriptions/f33478a5-1225-4e47-843f-2480e05a5ad8/resourceGroups/SIS-PD-IM-50-T0-RG001/providers/Microsoft.Compute/images/SISPDDB50WIMG001'
    ##Key Vault
    ...
    $OptionalParameters['pIPAddress'] = Powershell -file ..\..\Scripts\Set-IPAllocator.ps1 -Path ..\..\Scripts\SIS-DB-SN001-172.21.8.0_21.csv -HostName ($AzureVMName + "-Nic")
    $OptionalParameters['sIPAddress'] = Powershell -file ..\..\Scripts\Set-IPAllocator.ps1 -Path ..\..\Scripts\SIS-DB-SN001-172.21.8.0_21.csv -HostName ($AzureVMName + "-BNic")
