...
Param(
    [string] $ResourceGroupLocation = 'Canada Central',
    [string] $SubscriptionName = 'PS-EXT-PD-50-SNGL',
    [string] $ResourceLocation = 'Canada Central',
    [string] $ResourceGroupName = 'SIS-PD-ST-50-FE-RG001',
    [switch] $UploadArtifacts = $true,
    [string] $StorageAccountName = "sispd50sragrssa003",
...
foreach ($AzureVMName in $AzureVMNames) {
    ...
    $OptionalParameters['resourceLocation'] = 'Canada Central'
    $OptionalParameters['virtualNetworkResourceGroup'] = 'TIER-PD-NW-50-T0-RG001'
    $OptionalParameters['virtualNetworkName'] = 'PS-EXT-PD-SNGL-50-VN001'
    $OptionalParameters['subnetName'] = "SIS-WB-SN001-172.21.0.0_21"
    $OptionalParameters['domainToJoin'] = "powerschool.host"
    $OptionalParameters['domainUsername'] = "sundeep.paluru"
    ##Golden Image Value
    $OptionalParameters['templateResourceID'] = '/subscriptions/f33478a5-1225-4e47-843f-2480e05a5ad8/resourceGroups/SIS-PD-IM-50-T0-RG001/providers/Microsoft.Compute/images/SISPDWB50WIMG001'
    ##Key Vault
    ...
    $OptionalParameters['pIPAddress'] = Powershell -file ..\..\Scripts\Set-IPAllocator.ps1 -Path ..\..\Scripts\SIS-WB-SN001-172.21.0.0_21.csv -HostName ($AzureVMName + "-Nic")
    $OptionalParameters['sIPAddress'] = Powershell -file ..\..\Scripts\Set-IPAllocator.ps1 -Path ..\..\Scripts\SIS-WB-SN001-172.21.0.0_21.csv -HostName ($AzureVMName + "-BNic")
