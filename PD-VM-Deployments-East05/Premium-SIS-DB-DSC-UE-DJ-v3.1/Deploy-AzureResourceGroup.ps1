...
Param(
    ...
    [string] $ResourceGroupName = 'SIS-PD-ST-05-BE-RG001',
    [switch] $UploadArtifacts = $true,
    [string] $StorageAccountName = "sispd05sragrssa002",
...
foreach ($AzureVMName in $AzureVMNames) {
    ...
    $OptionalParameters['subnetName'] = 'SIS-DB-SN001-172.22.168.0_21'
    $OptionalParameters['domainToJoin'] = "powerschool.host"
    $OptionalParameters['domainUsername'] = "sundeep.paluru"
    ##Golden Image Value
    $OptionalParameters['templateResourceID'] = '/subscriptions/cb4b3507-2386-40fa-9b55-975e5fd342e7/resourceGroups/SIS-PD-IM-05-T0-RG001/providers/Microsoft.Compute/images/SISPDDB05WIMG001'
    ##Key Vault
    ...
    $OptionalParameters['pIPAddress'] = Powershell -file ..\..\Scripts\Set-IPAllocator.ps1 -Path ..\..\Scripts\SIS-DB-SN001-172.23.136.0_21.csv -HostName ($AzureVMName + "-Nic")
    $OptionalParameters['sIPAddress'] = Powershell -file ..\..\Scripts\Set-IPAllocator.ps1 -Path ..\..\Scripts\SIS-DB-SN001-172.23.136.0_21.csv -HostName ($AzureVMName + "-BNic")
