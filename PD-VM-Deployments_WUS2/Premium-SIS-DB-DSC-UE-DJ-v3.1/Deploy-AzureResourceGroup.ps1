...
Param(
    ...
    [string] $ResourceGroupName = 'SIS-PD-ST-20-BE-RG001',
    [switch] $UploadArtifacts = $true,
    [string] $StorageAccountName = "sispd20sragrssa002",
...
foreach($AzureVMName in $AzureVMNames){
            ...
            $OptionalParameters['subnetName'] = 'SIS-DB-SN002-172.21.136.0_21'
            $OptionalParameters['domainToJoin'] = "powerschool.host"
            $OptionalParameters['domainUsername'] = "sundeep.paluru"
	            ##Golden Image Value
            $OptionalParameters['templateResourceID'] = '/subscriptions/fedb6b9b-8def-4ccb-947b-4a87809a7b2e/resourceGroups/SIS-PD-IM-20-T0-RG001/providers/Microsoft.Compute/images/SISPDDB20WIMG001'
	            ##Key Vault
            ...
            $OptionalParameters['pIPAddress'] = Powershell -file ..\..\Scripts\Set-IPAllocator.ps1 -Path ..\..\Scripts\SIS-DB-SN002-172.21.136.0_21.csv -HostName ($AzureVMName+"-Nic")
            $OptionalParameters['sIPAddress'] = Powershell -file ..\..\Scripts\Set-IPAllocator.ps1 -Path ..\..\Scripts\SIS-DB-SN002-172.21.136.0_21.csv -HostName ($AzureVMName+"-BNic")
