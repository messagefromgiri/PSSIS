...
foreach($AzureVMName in $AzureVMNames){
                ...
                $OptionalParameters['subnetName'] = "SIS-WB-SN001-172.21.128.0_22"
                ...
                $OptionalParameters['pIPAddress'] = Powershell -file ..\..\Scripts\Set-IPAllocator.ps1 -Path ..\..\Scripts\SIS-WB-SN001-172.21.128.0_22.csv -HostName ($AzureVMName+"-Nic")
                $OptionalParameters['sIPAddress'] = Powershell -file ..\..\Scripts\Set-IPAllocator.ps1 -Path ..\..\Scripts\SIS-WB-SN001-172.21.128.0_22.csv -HostName ($AzureVMName+"-BNic")
