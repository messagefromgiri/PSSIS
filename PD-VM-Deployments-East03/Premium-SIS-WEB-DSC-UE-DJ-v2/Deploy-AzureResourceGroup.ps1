...
Param(
    ...
    [string] $ResourceGroupName = 'SIS-PD-ST-03-FE-RG001',
    [switch] $UploadArtifacts = $true,
    [string] $StorageAccountName = "sispd03sragrssa003",
...
foreach ($AzureVMName in $AzureVMNames) {
    ...
    ##Golden Image Value
    $OptionalParameters['templateResourceID'] = '/subscriptions/d009f288-0c40-4c42-90aa-73d58c0ae24f/resourceGroups/SIS-PD-IM-03-T0-RG001/providers/Microsoft.Compute/images/SISPDWB03WIMG001'
    ##Key Vault
