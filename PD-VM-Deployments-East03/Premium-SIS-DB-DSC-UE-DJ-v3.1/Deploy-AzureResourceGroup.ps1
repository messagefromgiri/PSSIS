...
Param(
    ...
    [string] $SubscriptionName = 'PS-EXT-PD-03-SNGL',
    [string] $ResourceLocation = 'East US',
    [string] $ResourceGroupName = 'SIS-PD-ST-03-BE-RG001',
    [switch] $UploadArtifacts = $true,
    [string] $StorageAccountName = "sispd03sragrssa002",
...
foreach ($AzureVMName in $AzureVMNames) {
    ...
    $OptionalParameters['subnetName'] = 'SIS-DB-SN001-172.22.136.0_21'
    $OptionalParameters['domainToJoin'] = "powerschool.host"
    $OptionalParameters['domainUsername'] = "sundeep.paluru"
    ##Golden Image Value
    $OptionalParameters['templateResourceID'] = '/subscriptions/d009f288-0c40-4c42-90aa-73d58c0ae24f/resourceGroups/SIS-PD-IM-03-T0-RG001/providers/Microsoft.Compute/images/SISPDDB03WIMG001'
    ##Key Vault
    ...
    $OptionalParameters['pIPAddress'] = Powershell -file ..\..\Scripts\Set-IPAllocator.ps1 -Path ..\..\Scripts\SIS-DB-SN001-172.22.136.0_21.csv -HostName ($AzureVMName + "-Nic")
    $OptionalParameters['sIPAddress'] = Powershell -file ..\..\Scripts\Set-IPAllocator.ps1 -Path ..\..\Scripts\SIS-DB-SN001-172.22.136.0_21.csv -HostName ($AzureVMName + "-BNic")
