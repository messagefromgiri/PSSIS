...
<#US East 3 Subscription
$besubnet = "172.22.136.0/21"
$mgmtsubnet = "172.20.216.208/28"
$f5subnet = "172.20.216.128/26"
$fesubnet = "172.22.128.0/21"
$location = "eastus"
$appsubscriptionId = "d009f288-0c40-4c42-90aa-73d58c0ae24f"
$mgmtSubscriptionId = "2918909d-37c3-4acd-87ec-480b42826789"
$appnsgrg = "TIER-PD-NW-03-T0-RG001"
$bensg = "NSG-SIS-DB-SN002-172.22.136.0_21"
$fensg = "NSG-SIS-WB-SN001-172.22.128.0_21"
$f5nsgrg = "TIER-PD-USE-T0-RG002"
$f5extnsg = "NSG-TIER-UT-SN003-172.20.216.128_26"#>

<#US West 2 Subscription
$besubnet = "172.21.168.0/21"
$mgmtsubnet = "172.20.216.208/28"
$f5subnet = "172.20.232.64/26"
$fesubnet = "172.21.160.0/21"
$location = "westus2"
$appsubscriptionId = "5930e30e-1a6f-442a-a393-207554949e83"
$mgmtSubscriptionId = "6d0b3073-cc4b-4ec9-a3ab-2a5630f28fe5"
$appnsgrg = "TIER-PD-NW-21-T0-RG001"
$bensg = "NSG-SIS-DB-SN002-172.21.168.0_21"
$fensg = "NSG-SIS-WB-SN001-172.21.160.0_21"
$f5nsgrg = "TIER-PD-USW-T0-RG002"
$f5extnsg = "NSG-TIER-UT-SN001-172.20.232.64_26" #>

#US East 3 Subscription
$besubnet = "172.22.168.0/21"
$mgmtsubnet = "172.20.216.208/28"
$f5subnet = "172.20.216.128/26"
$fesubnet = "172.22.160.0/21"
$location = "eastus"
$appsubscriptionId = "857c1477-d81b-418e-8867-d26eaf6d4d5b"
$mgmtSubscriptionId = "2918909d-37c3-4acd-87ec-480b42826789"
$appnsgrg = "TIER-PD-NW-04-T0-RG001"
$bensg = "NSG-SIS-DB-SN001-172.22.168.0_21"
$fensg = "NSG-SIS-WB-SN002-172.22.160.0_21"
$f5nsgrg = "TIER-PD-USE-T0-RG002"
$f5extnsg = "NSG-TIER-UT-SN003-172.20.216.128_26"
...
Select-AzureRmSubscription -Subscription $appsubscriptionId
 ...
 #$besubnet 
 $berule8 = New-AzureRmNetworkSecurityRuleConfig -Name Allow-Inbound-SIF-DAC -Description "Rule8" -Access Allow -Protocol * -Direction Inbound  -Priority 420 -SourceAddressPrefix 172.21.64.123,172.21.64.115 -SourcePortRange * -DestinationAddressPrefix $besubnet -DestinationPortRange 1521 
 $berule7 = New-AzureRmNetworkSecurityRuleConfig -Name Allow-Inbound-AWS-UCProd -Description "Rule7" -Access Allow -Protocol * -Direction Inbound  -Priority 430 -SourceAddressPrefix 10.217.32.0/19,10.217.64.0/19,10.217.96.0/19 -SourcePortRange * -DestinationAddressPrefix $besubnet -DestinationPortRange 1521 
 $berule6 = New-AzureRmNetworkSecurityRuleConfig -Name Allow-Inbound-STGServers -Description "Rule6" -Access Allow -Protocol * -Direction Inbound  -Priority 440 -SourceAddressPrefix 172.20.209.4/32,172.20.209.69/32,172.21.64.4/32 -SourcePortRange * -DestinationAddressPrefix VirtualNetwork -DestinationPortRange * 
 $berule5 = New-AzureRmNetworkSecurityRuleConfig -Name Allow-Inbound-MGMTSubnet -Description "Rule5" -Access Allow -Protocol * -Direction Inbound  -Priority 460 -SourceAddressPrefix 172.20.216.208/28,172.20.209.0/24,172.20.216.64/26 -SourcePortRange * -DestinationAddressPrefix $besubnet -DestinationPortRange 3389,22  
 ...
 #Create NSG
 $nsg = New-AzureRmNetworkSecurityGroup -ResourceGroupName $appnsgrg -Location $location -Name $bensg -SecurityRules $berule0,$berule1,$berule2,$berule3,$berule4,$berule5,$berule6,$berule7,$berule8 -Verbose -Force  
   
   
#$fesubnet 
$ferule8 = New-AzureRmNetworkSecurityRuleConfig -Name Allow-Inbound-SIF -Description "Rule8" -Access Allow -Protocol * -Direction Inbound  -Priority 430 -SourceAddressPrefix 172.21.64.123 -SourcePortRange * -DestinationAddressPrefix $fesubnet -DestinationPortRange 138,139,445
$ferule7 = New-AzureRmNetworkSecurityRuleConfig -Name Allow-Inbound-STGServers -Description "Rule7" -Access Allow -Protocol * -Direction Inbound  -Priority 440 -SourceAddressPrefix 172.20.209.4/32,172.20.209.69/32,172.24.32.16/32,172.22.16.164/32,172.21.64.4/32 -SourcePortRange * -DestinationAddressPrefix VirtualNetwork -DestinationPortRange *
...
$ferule5 = New-AzureRmNetworkSecurityRuleConfig -Name Allow-Inbound-MGMTSubnet -Description "Rule5" -Access Allow -Protocol * -Direction Inbound  -Priority 460 -SourceAddressPrefix 172.20.216.208/28,172.20.209.0/24,172.20.216.64/26 -SourcePortRange * -DestinationAddressPrefix $fesubnet -DestinationPortRange 3389,22  
...
$ferule0 = New-AzureRmNetworkSecurityRuleConfig -Name Deny-Inbound-FEsubnet -Description "Rule0" -Access Deny -Protocol * -Direction Inbound  -Priority 510 -SourceAddressPrefix * -SourcePortRange * -DestinationAddressPrefix $fesubnet -DestinationPortRange *  
 ...
 $nsg = New-AzureRmNetworkSecurityGroup -ResourceGroupName $appnsgrg -Location $location -Name $fensg -SecurityRules $ferule0,$ferule1,$ferule2,$ferule3,$ferule4,$ferule5,$ferule6,$ferule7,$ferule8 -Verbose -Force  
