...
Param(
    ...
    [string] $ResourceGroupName = 'SIS-PD-ST-21-BE-RG001',
    [switch] $UploadArtifacts = $true,
    [string] $StorageAccountName = "sispd21sragrssa002",
...
foreach ($AzureVMName in $AzureVMNames) {
    ...
    $OptionalParameters['subnetName'] = 'SIS-DB-SN001-172.21.168.0_21'
    $OptionalParameters['domainToJoin'] = "powerschool.host"
    $OptionalParameters['domainUsername'] = "sundeep.paluru"
    ##Golden Image Value
    $OptionalParameters['templateResourceID'] = '/subscriptions/5930e30e-1a6f-442a-a393-207554949e83/resourceGroups/SIS-PD-IM-21-T0-RG001/providers/Microsoft.Compute/images/SISPDDB21WIMG001'
    ##Key Vault
    ...
    $OptionalParameters['pIPAddress'] = Powershell -file ..\..\Scripts\Set-IPAllocator.ps1 -Path ..\..\Scripts\SIS-DB-SN001-172.21.168.0_21.csv -HostName ($AzureVMName + "-Nic")
    $OptionalParameters['sIPAddress'] = Powershell -file ..\..\Scripts\Set-IPAllocator.ps1 -Path ..\..\Scripts\SIS-DB-SN001-172.21.168.0_21.csv -HostName ($AzureVMName + "-BNic")
