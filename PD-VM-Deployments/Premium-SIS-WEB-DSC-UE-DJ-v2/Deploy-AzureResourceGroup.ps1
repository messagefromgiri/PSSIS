...
Param(
    ...
    [string] $SubscriptionName='PS-EXT-PD-SNGL-USE',
    [string] $ResourceLocation='East US',
    [string] $ResourceGroupName = 'SIS-PD-ST-00-FE-RG001',
    [switch] $UploadArtifacts = $true,
    [string] $StorageAccountName = "sispd00sragrssa003",
...
foreach($AzureVMName in $AzureVMNames){
                ...
                $OptionalParameters['virtualNetworkResourceGroup'] = 'TIER-PD-NW-01-T0-RG001'
                $OptionalParameters['virtualNetworkName'] = 'PS-EXT-PD-SNGL-01-VN001'
                $OptionalParameters['subnetName'] = "SIS-WB-SN001-172.21.64.0_22"
                $OptionalParameters['domainToJoin'] = "powerschool.host"
                $OptionalParameters['domainUsername'] = "sundeep.paluru"
	                ##Golden Image Value
                $OptionalParameters['templateResourceID'] = '/subscriptions/8adc65ab-342a-48ca-ba24-c0a43042c519/resourceGroups/SIS-PD-IM-00-T0-RG001/providers/Microsoft.Compute/images/SISPDWB00WIMG001'
	                ##Key Vault
               ...
               # $OptionalParameters['sIPAddress'] = Powershell -file ..\..\Scripts\Set-IPAllocator.ps1 -Path ..\..\Scripts\SIS-WB-SN001-172.21.64.0_22.csv -HostName ($AzureVMName+"-BNic")
                ...
                $OptionalParameters['pIPAddress'] = "172.21.64.113"
                $OptionalParameters['sIPAddress'] = "172.21.64.114"
