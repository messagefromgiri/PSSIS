...
Param(
    ...
    [string] $ResourceGroupName = 'SIS-PD-ST-00-BE-RG001',
    [switch] $UploadArtifacts = $true,
    [string] $StorageAccountName = "sispd00sragrssa002",
...
foreach($AzureVMName in $AzureVMNames){
            ...
            $OptionalParameters['subnetName'] = 'SIS-DB-SN002-172.21.72.0_21'
            $OptionalParameters['domainToJoin'] = "powerschool.host"
            $OptionalParameters['domainUsername'] = "sundeep.paluru"
	            ##Golden Image Value
            $OptionalParameters['templateResourceID'] = '/subscriptions/8adc65ab-342a-48ca-ba24-c0a43042c519/resourceGroups/SIS-PD-IM-00-T0-RG001/providers/Microsoft.Compute/images/SISPDDB00WIMG001'
	            ##Key Vault
            ...
            #$OptionalParameters['pIPAddress'] = "172.21.72.18"
            #$OptionalParameters['sIPAddress'] = "172.21.72.19"
